...
## Training Goal
Build the qualities Deka Strong demands: strength and endurance across 10 back-to-back zones with **no running**. The key differentiator from Deka Fit — sessions develop sustained work capacity under load, grip endurance, and leg power without any running component.

**Race format for reference:** 10 zones completed back-to-back in order as fast as possible. No running between zones. Training sessions are NOT mini copies of the event.
